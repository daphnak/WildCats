...
(cl:defmethod cl:initialize-instance :after ((m <GotoResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GotoResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<GotoResult> is deprecated: use beginner_tutorials-msg:GotoResult instead.")))

(cl:ensure-generic-function 'total_dishes_cleaned-val :lambda-list '(m))
(cl:defmethod total_dishes_cleaned-val ((m <GotoResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-msg:total_dishes_cleaned-val is deprecated.  Use beginner_tutorials-msg:total_dishes_cleaned instead.")
